...
for($i=0;$i<count($tweets);$i++){
	...
	$tweetCode='<div class="tweet" tweetid="'.$tweets[$i]['tweet'].'" rating="'.$tweets[$i]['rating'].'"><div class="text">'.$tweets[$i]['text'].'</div></div>';
