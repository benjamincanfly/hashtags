<?php
	...
	if(isset($_SESSION['user_id'])){
		...
		if($num==0 && $unclaimed>=100){
			$qs=sprintf("update tweets set assigned_to_user_id='%s', assignment_time=CURRENT_TIMESTAMP where assigned_to_user_id='0' and hashtag='%s' order by id ASC limit 100",
